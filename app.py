...
def main():
    global counter
    st.title("Welcome to the world of Money Advisory")
    ...
    # Home Menu
    if choice == "Home":
        st.write("I am your Money Advisory. Please Ask Your Question and Doubts To Get Best Solution for Your Money")
